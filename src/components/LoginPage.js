...
function LoginPage(props) {
  ...
  return (
    <Container maxWidth="sm" className={classes.root}>
      <div>{error}</div>
      <Typography variant='h2' className={classes.child} style={{textAlign: 'center'}}>Login</Typography>
      <Typography variant='p' className={classes.child} style={{textAlign: 'center'}}>To view teacher dashboard, login in with the following credentials: email: 'testteacher@gmail.com' password: 'password'</Typography>
