...
function HomePage(props) {
  ...
  return (
    <Container className={classes.root} maxWidth='xl'>
      <Typography variant="h1" className={classes.child}>Welcome to Lessons Test App!</Typography>
      <Typography variant='body1' className={classes.child} style={{textAlign: 'center', width: '50%'}}>{quote.contents?.quotes[0].quote} - {quote.contents?.quotes[0].author}</Typography>
