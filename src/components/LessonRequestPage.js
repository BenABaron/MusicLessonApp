...
function LessonRequestPage(props) {
  ...
  return (
    <Container className={classes.container}>
      ...
      <Typography variant='p' className={classes.child}>Note: Once a lesson is accepted, only lessons within a week will be shown in the teacher's schedule.</Typography>
